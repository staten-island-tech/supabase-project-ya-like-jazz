<template>
  <div class="container w-20 flex justify-end">
    <ul class="bg-color-2 h-fit p-6 rounded-lg">
      ...
      <li
        @click="changeTab(2)"
        class="cursor-pointer text-xl mt-2 text-1 hover:bg-hover3 rounded-lg h-8 flex justify-end"
      >
        Random1
      </li>
      <li
      ...
      <li
        @click="changeTab(4)"
        class="cursor-pointer text-xl mt-2 text-1 hover:bg-hover3 rounded-lg h-8 flex justify-end w-36"
      >
        Random3
      </li>
    </ul>
